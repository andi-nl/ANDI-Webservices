...
json <- fromJSON("examplejson.json")
##########################################################################
...
mypatdata$AGE <- mypatdata$AGE
  ...
  as.period(interval(ymd(substring(mypatdata$dob,1,10)),ymd(substring(mypatdata$dot,1,10)))$year - 65
                           ...
                           # defaultvalues
                           load("C:/Users/jagelin1/Documents/Nan/Non-normality3/PrepforMplus/summarystats.RData") # Anand, look here
                           
                           ANDImetadata <- read.csv("C:/Users/jagelin1/Documents/Nan/Non-normality3/PrepforMplus/metadataforMMNCandpatient.csv") # Anand, look here
